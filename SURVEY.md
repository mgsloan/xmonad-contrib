...
is somewhere between 126 and 280.
...
### X window properties — 12 modules
...
### `XMonad.Util.XSelection` — 92 modules
...
### `XMonad.Hooks.Rescreen`, `XMonad.Util.XSelection` — 5 modules
...
### `XMonad.Hooks.SetWMName`, `XMonad.Util.XSelection` — 3 modules

`XMonad.Actions.ToggleFullFloat`, `XMonad.Actions.WorkspaceNames`, `XMonad.Hooks.EwmhDesktops`

### `XMonad.Layout.WindowNavigation`, `XMonad.Util.XSelection` — 3 modules

`XMonad.Hooks.WindowSwallowing`, `XMonad.Layout.ComboP`, `XMonad.Layout.SubLayouts`

### `XMonad.Hooks.RefocusLast`, `XMonad.Util.XSelection` — 3 modules
