...
is somewhere between 123 and 281.
...
### missing module or export — 11 modules
...
### X window properties — 11 modules
...
### `XMonad.Actions.Submap` — 5 modules

`XMonad.Actions.Navigation2D`, `XMonad.Actions.UpKeys`, `XMonad.Config.Prime`, `XMonad.Util.EZConfig`, `XMonad.Util.NamedActions`

### `XMonad.Hooks.Rescreen`, `XMonad.Util.NamedWindows` (+2 more) — 5 modules

`XMonad.Actions.Profiles`, `XMonad.Hooks.DynamicBars`, `XMonad.Hooks.DynamicLog`, `XMonad.Hooks.StatusBar`, `XMonad.Util.Hacks`

### `XMonad.Hooks.SetWMName`, `XMonad.Util.Cursor` (+1 more) — 5 modules
...
### `XMonad.Actions.Submap`, `XMonad.Util.XSelection` — 3 modules

`XMonad.Actions.KeyRemap`, `XMonad.Actions.Prefix`, `XMonad.Util.Paste`

### `XMonad.Util.Timer` — 3 modules

`XMonad.Actions.ShowText`, `XMonad.Hooks.ShowWName`, `XMonad.Layout.ShowWName`

### `XMonad.Hooks.RefocusLast`, `XMonad.Util.NamedWindows` (+2 more) — 3 modules

`XMonad.Util.Loggers.NamedScratchpad`, `XMonad.Util.NamedScratchpad`, `XMonad.Util.Scratchpad`

### `XMonad.Hooks.SetWMName`, `XMonad.Util.XSelection` — 2 modules

`XMonad.Actions.ToggleFullFloat`, `XMonad.Hooks.EwmhDesktops`

### `XMonad.Layout.WindowNavigation`, `XMonad.Util.NamedWindows` (+2 more) — 2 modules

`XMonad.Hooks.WindowSwallowing`, `XMonad.Layout.SubLayouts`

### `XMonad.Util.NamedWindows` — 1 modules

`XMonad.Actions.TreeSelect`

### `XMonad.Hooks.SetWMName`, `XMonad.Util.NamedWindows` (+2 more) — 1 modules

`XMonad.Actions.WorkspaceNames`

### `XMonad.Hooks.Rescreen`, `XMonad.Hooks.ServerMode` (+4 more) — 1 modules

`XMonad.Config.Arossato`

### `XMonad.Hooks.CurrentWorkspaceOnTop`, `XMonad.Hooks.ServerMode` (+8 more) — 1 modules

`XMonad.Config.Bluetile`

### `XMonad.Actions.Warp`, `XMonad.Hooks.Rescreen` (+4 more) — 1 modules

`XMonad.Config.Dmwit`

### `XMonad.Hooks.SetWMName`, `XMonad.Layout.DragPane` (+5 more) — 1 modules

`XMonad.Config.Droundy`

### `XMonad.Actions.Submap`, `XMonad.Hooks.Rescreen` (+6 more) — 1 modules

`XMonad.Config.Example`

### `XMonad.Hooks.SetWMName`, `XMonad.Util.Cursor` (+2 more) — 1 modules

`XMonad.Config.Mate`

### `XMonad.Hooks.FadeInactive`, `XMonad.Hooks.RefocusLast` (+6 more) — 1 modules

`XMonad.Config.Saegesser`

### `XMonad.Hooks.Rescreen`, `XMonad.Hooks.SetWMName` (+5 more) — 1 modules
...
### `XMonad.Actions.FloatKeys`, `XMonad.Actions.Submap` (+4 more) — 1 modules
...
### `XMonad.Layout.WindowNavigation`, `XMonad.Util.XSelection` — 1 modules

`XMonad.Layout.ComboP`

### `XMonad.Layout.Reflect`, `XMonad.Util.XSelection` — 1 modules
...
### `XMonad.Hooks.FadeInactive`, `XMonad.Util.XSelection` — 1 modules
...
### `XMonad.Util.Timer`, `XMonad.Util.XSelection` — 1 modules
